...
from .frameCycleCalculator import NODE_CLASS_MAPPINGS as FRAMECYCLECALCULATOR_NODE_CLASS_MAPPINGS, NODE_DISPLAY_NAME_MAPPINGS as FRAMECYCLECALCULATOR_NODE_DISPLAY_NAME_MAPPINGS
...
NODE_CLASS_MAPPINGS.update(FRAMECYCLECALCULATOR_NODE_CLASS_MAPPINGS)
...
NODE_DISPLAY_NAME_MAPPINGS.update(FRAMECYCLECALCULATOR_NODE_DISPLAY_NAME_MAPPINGS)
